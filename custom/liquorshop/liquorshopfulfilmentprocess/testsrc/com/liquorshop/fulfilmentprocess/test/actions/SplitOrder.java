 ...
 */
package com.liquorshop.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(LiquorshopFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(LiquorshopFulfilmentProcessConstants.PARENT_PROCESS);
