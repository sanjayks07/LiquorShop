 ...
 */
package com.liquorshop.test.setup;
...
import com.liquorshop.test.constants.LiquorshopTestConstants;
import com.liquorshop.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = LiquorshopTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/liquorshoptest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/liquorshoptest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/liquorshoptest/import/cstickets.impex");
			...
			importImpexFile(context, "/liquorshoptest/import/csquotes.impex");
		}
	}
}
