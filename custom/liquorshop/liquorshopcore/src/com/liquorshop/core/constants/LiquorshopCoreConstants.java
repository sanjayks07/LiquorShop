 ...
 */
package com.liquorshop.core.constants;

/**
 * Global class for all LiquorshopCore constants. You can add global constants for your extension into this class.
 */
public final class LiquorshopCoreConstants extends GeneratedLiquorshopCoreConstants
{
	public static final String EXTENSIONNAME = "liquorshopcore";


	private LiquorshopCoreConstants()
	{
		//empty
	}
