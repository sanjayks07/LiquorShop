...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/liquorshopstorefront/electronics/en",
						"https://electronics.local:9002/liquorshopstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/liquorshopstorefront/electronics/en",
						"https://electronics.local:9002/liquorshopstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/liquorshopstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/liquorshopstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/liquorshopstorefront/electronics/en",
						"https://electronics.local:9002/liquorshopstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/liquorshopstorefront",
						"https://electronics.local:9002/liquorshopstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/liquorshopstorefront",
						"https://electronics.local:9002/liquorshopstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/liquorshopstorefront/electronics/en",
						"https://electronics.local:9002/liquorshopstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
